...
Connect-SPO -siteUrl $taSite -callback {
  Set-PnPStorageEntity -Key MicrosoftCustomLearningCdn -Value "https://pnp.github.io/custom-learning-office-365/learningpathways/" `
    -Description "Microsoft 365 learning pathways CDN source" -ErrorAction Stop;
