...
Set-PnPStorageEntity -Key MicrosoftCustomLearningCdn -Value "https://pnp.github.io/custom-learning-office-365/v2/" -Description "CDN source for Microsoft Content"
